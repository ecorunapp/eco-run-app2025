  ...
  return (
    <div className="flex flex-col min-h-screen bg-eco-dark text-eco-light">
      ...
      <main className="flex-grow p-4 space-y-6 overflow-y-auto pb-24"> {/* pb-24 for bottom nav space */}
        {/* EcoPoints Display */}
        <section className="text-center p-6 bg-gradient-to-br from-eco-accent to-eco-purple rounded-2xl shadow-xl animate-fade-in-up">
        ...
        {/* Key Stats */}
        <section className="grid grid-cols-2 sm:grid-cols-3 gap-4 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
        ...
        {/* Placeholder for other sections like "Challenges" or "Friends Activity" */}
        <section className="bg-eco-dark-secondary p-4 rounded-xl shadow animate-fade-in-up" style={{ animationDelay: '0.6s' }}>
